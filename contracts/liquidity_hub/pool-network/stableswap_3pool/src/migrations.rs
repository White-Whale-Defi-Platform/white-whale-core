...
use terraswap::trio::{Config, FeatureToggle};
use white_whale::fee::Fee;

use crate::state::{ALL_TIME_BURNED_FEES, CONFIG, TRIO_INFO};
...
pub fn migrate_to_v120(deps: DepsMut) -> Result<(), StdError> {
    ...
    let config = Config {
        ...
        pool_fees: terraswap::trio::PoolFee {
        ...
        amp_factor: config_v110.amp_factor,
    };
